...
function calcularPrecios() {
  ...
  while (respuesta == "si") {
    productoIngresado = prompt(`Ingrese un producto de la lista, el precio final acumulado será mostrado al final,  $10 termo  $5 mate o $2 bombilla`);
    ...
    alert('Si compra 3 unidades o mas en total de cualquier item, tendrá un 10% de descuento!');
